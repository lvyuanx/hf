...
from hf_system.core.models.structure_module_base import StructureModuleBase

prefix = "s_manager"


# 角色标识枚举
class SRoleLabel(models.TextChoices):
    身份标识 = 'USER_ROLE'
...
class SRole(models.Model):
    ...
    create_user = models.BigIntegerField(null=True, verbose_name="创建人")
    create_time = models.DateTimeField(auto_now_add=True, verbose_name="创建时间")
    update_user = models.BigIntegerField(null=True, verbose_name="更新人")
